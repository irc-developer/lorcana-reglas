...
**1.11.2.** Some characters and locations have a Lore value represented by {L} on the card. A questing character with a Lore value causes that player to gain the amount of lore represented by the character’s Lore value. If a questing character doesn’t have a Lore value or their Lore value has been reduced to 0, the player doesn’t gain any lore and their lore total doesn’t increase. A location with a Lore value causes that player to gain the amount of lore represented by the location’s Lore value at the start of that player’s turn (see 3.2.2).
