...
> Este archivo no sustituye la sección 1 del PDF oficial 2.2. Consulte `Documentacion Oficial/Comprehensive-Rules_2.2.0-EN.pdf`.
...
**1.9.4.** Damage being dealt occurs because of a challenge or a resolving effect. To determine the total amount of damage that occurs, follow the steps listed here in order.

**1.9.4.1.** First, determine the base damage. If the damage is from a resolving effect, the base damage is defined in the text of the effect. If the damage is from a challenge, the base damage is defined as the character’s {S} in the challenge.

**1.9.4.2.** Second, any damage modifiers are applied in any order to the base damage number.

**1.9.4.3.** Third, the resulting number is the total amount of damage. Damage counters are placed on each character or location as a result of the challenge (see 4.6.6.2) or as defined by the effect (see 6.7.2.2). All instances of damage from the challenge or same effect happen at the same time.

> **Example A:** A player plays Smash, an action that has the effect, “Deal 3 damage to chosen character.” They choose Flounder – Voice of Reason, a character with 2 {W}. To determine the total amount of damage Flounder takes, first start with the base damage of Smash, which is 3. Next, apply any modifiers to the damage. Since there are none, the damage remains unmodified at 3. Finally, the total number of damage is 3, and 3 damage counters are placed on Flounder.

> **Example B:** A player plays Smash, an action that has the effect, “Deal 3 damage to chosen character.” They choose Namaari – Resolute Daughter, a character with Resist +3. To determine the total amount of damage Namaari takes, first start with the base damage of Smash, which is 3. Next, apply any modifiers to the damage. Resist +3 reduces the amount of damage dealt to Namaari by 3, so the damage is modified to 0. Finally, the total number of damage is 0, and no damage counters are placed on Namaari.

**1.9.5.** If a character or effect would deal damage and that damage is reduced to 0 when modifiers are applied, the character or effect is still considered to “deal” damage. If a character or location is dealt damage and that damage is reduced to 0 when modifiers are applied, the character or location “takes” no damage.

> **Example:** A player has Merida – Formidable Archer in play. Merida has the ability Steady Aim that reads, “Whenever one of your actions deals damage to an opposing character, deal 2 damage to that character.” The player plays Smash, an action that has the effect, “Deal 3 damage to chosen character.” The player chooses Namaari – Resolute Daughter, a character with Resist +3. Smash deals 3 damage, but Namaari takes 0 damage because of Resist +3. Because Smash is still considered to deal damage, Merida’s Steady Aim triggered ability occurs and is added to the bag.

**1.9.6.** When a character or location with damage leaves play for any reason, all damage counters on that character or location cease to exist.
...
**1.10.1.3.** Some cards have abilities that adjust deck construction rules. These abilities function outside of the game but apply only if that card could be included in the deck in the first place.

> **Example:** Chrisopher Robin – Hunny Sage has the ability Gather the Party that reads, “You can have other Hunny characters in your deck regardless of ink type.” Christopher Robin has the ink types Amethyst and Sapphire and the Hunny classification. Christopher Robin can only be included in a deck whose ink types are Amethyst and Sapphire, but his ability allows other Hunny characters to be in the deck regardless of their ink types.
