...
**No.** Si no puedes pagar 1 tinta o decides no pagarla, se trata como responder «no» al `may` del efecto. No ocurre ninguna parte de esa frase: no se elige personaje, no se endereza a nadie y no se aplica ninguna restricción para el resto del turno.
...
3. Si no pagas o no puedes pagar, la frase termina sin efecto.
4. Solo si pagas se elige un personaje propio, se endereza y queda sin poder irse de aventura ni desafiar durante el resto del turno.
...
#alternate-cost #triggered-ability #resolution
