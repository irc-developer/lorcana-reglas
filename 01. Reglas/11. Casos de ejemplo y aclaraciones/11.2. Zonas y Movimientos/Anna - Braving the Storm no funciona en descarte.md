...
- [[01. Reglas/5. Cartas y tipos de carta (Cards and Card types)/5.3. Personajes (Characters)#5.3.6.4. Valor de Lore (Lore Value)|5.3.6.4. Valor de Lore]]: el valor de lore es una característica del personaje/carta usada para determinar cuánto lore genera al questear o cuando un efecto referencia ese valor.
- [[01. Reglas/6. Habilidades, efectos y resolución (abilities, effects, and resolving)/6.4. Habilidades Estáticas (Static Abilities)#6.4.1. Definición|6.4.1. Definición]]: una habilidad estática sin duración impresa permanece activa mientras la carta que la genera esté en juego.
- [[01. Reglas/6. Habilidades, efectos y resolución (abilities, effects, and resolving)/6.4. Habilidades Estáticas (Static Abilities)#6.4.2.3. Habilidades estáticas continuas generadas por cartas en juego|6.4.2.3. Habilidades estáticas continuas generadas por cartas en juego]]: si la carta fuente sale del Play zone, el efecto termina inmediatamente.
- [[01. Reglas/6. Habilidades, efectos y resolución (abilities, effects, and resolving)/6.1. General (General)#6.1.12. Algunas habilidades funcionan fuera de la zona de juego (Play zone).|6.1.12. Algunas habilidades funcionan fuera de la zona de juego]]: solo funcionan fuera de juego si el propio texto lo indica.
