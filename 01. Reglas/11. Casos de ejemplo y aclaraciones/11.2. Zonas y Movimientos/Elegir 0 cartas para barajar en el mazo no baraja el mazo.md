...
- [[01. Reglas/6. Habilidades, efectos y resolución (abilities, effects, and resolving)/6.7. Resolución de Cartas y Efectos (Resolving Cards and Effects)#6.7.2.4. Cuarto paso - resolución del texto|6.7.2.4. Hacer todo lo posible en el orden escrito]]: el efecto se resuelve en orden y se hace todo lo posible, pero no añade instrucciones que el texto no contiene.
