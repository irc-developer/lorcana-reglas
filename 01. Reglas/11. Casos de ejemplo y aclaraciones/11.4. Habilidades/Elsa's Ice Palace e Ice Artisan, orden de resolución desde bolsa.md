...
2. Luego resuelvo **ETERNAL WINTER** (Elsa's Ice Palace) para elegir ese personaje recién agotado como objetivo?

O, ¿requiere Ice Palace tener un objetivo legal válido **cuando se añade a la bolsa**?

## ✅ Respuesta

**Sí, puedes hacerlo. El orden de resolución que describes es válido.**

**Razón:**
- Ambas habilidades se añaden a la bolsa simultáneamente ([[7.7. Bolsa (Bag)|7.7.3.1]])
- Como jugador activo, **tú eliges el orden de resolución** ([[7.7. Bolsa (Bag)|7.7.4.2]])
...
12. **Fin de resolución**: Ambas habilidades se han resuelto
