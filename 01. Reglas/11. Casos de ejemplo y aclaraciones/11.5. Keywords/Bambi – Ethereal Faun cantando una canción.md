...
- [[1.5 Costes (Costs)#1.5.5.1. Cantar|1.5.5.1. Cantar]]
- [[1.7. Game Actions, Timing, y Illegal Actions#1.7.2. Resolución completa|1.7.2. Resolución completa]]
...
5. **GSC**: tras la resolución de cada efecto se realiza chequeo del estado del juego.

---

## 🏷️ Tags

#bag #bambi #habilidaddisparada #song #timing