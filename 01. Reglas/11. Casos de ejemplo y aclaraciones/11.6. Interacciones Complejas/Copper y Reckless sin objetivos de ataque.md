...
Si no hay nada para atacar en el lado del oponente, ¿puede Copper hacer quest para +1 lore gracias a Donald Duck?

---

## ✅ Respuesta

No. Copper no puede hacer quest. Reckless contiene una prohibición absoluta: *"can't quest"*.

Las habilidades de Donald Duck no pueden anular esta prohibición. El "if able" en Reckless solo modifica la parte de "must challenge each turn"; es decir, si no hay objetivos para atacar, esa restricción no aplica. Sin embargo, la prohibición de "can't quest" es permanente e incondicional.

**Resultado:** Copper no puede hacer nada ese turno si no hay objetivos para atacar (no puede hacer quest, y no hay nada que desafiar).
...
- **"Can't [action]"** = Prohibición absoluta e incondicional. El personaje nunca puede ejecutar esa acción.
- **"Must [action] if able"** = Restricción condicional. El personaje debe ejecutar la acción SOLO si existe al menos una opción legal para hacerlo. Si no existen opciones legales, la restricción no aplica.
...
#reckless #can-not #must-if-able #static-ability #restriction #conditional-restriction #absolute-prohibition
