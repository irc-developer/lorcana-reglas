...
### Caso C — **Sí**
Al jugar una carta por efecto, sigues el procedimiento normal de “jugar una carta”, incluyendo elección de modo de juego/coste alternativo cuando sea legal. Si cumples Sing Together, puedes usarlo.
...
- [[We Know The Way no puede seleccionarse a sí misma#âœ… Respuesta|We Know The Way no puede seleccionarse a sí misma]]

---

## 🔄 Secuencia oficial

1. **Coste**: la acción se juega desde la mano o por instrucción de otra carta, eligiendo modo de juego legal (incluido coste alternativo cuando aplique).
2. **Objetivos**: se eligen objetivos conforme al texto de la acción en el momento que corresponda.
3. **Resolución**: se resuelven instrucciones en orden escrito, haciendo todo lo posible.
4. **Disparos**: los triggers generados durante la resolución se añaden a la bolsa y esperan según reglas de resolución.
5. **GSC**: tras cada resolución de efecto se realiza chequeo del estado del juego.
