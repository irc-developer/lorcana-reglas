...
**Nota importante**: El oponente sigue teniendo control de **a qué personaje** aplica el efecto. Si el efecto dice "elegir 2 personajes" y John Smith es válido, el oponente DEBE incluirlo en la selección, pero elige los otros personajes. No puede rehuirlo eligiendo menos personajes si la acción requiere exactas (no "up to").
...
Las habilidades estáticas pueden crear restricciones sobre qué objetivos se pueden elegir. Una restricción con "if able" es condicional: requiere elegir el objetivo restringido SOLO si existe al menos una opción legal que lo cumpla.
