...
Sí. La restricción de "Do your worst" SÍ aplica en este caso.

Hypnotic Strength dice "Chosen character" sin especificar "character you control" o "your character". Esto significa que el oponente puede elegir **CUALQUIER personaje**, incluyendo a John Smith.

Por lo tanto, cuando el oponente juega Hypnotic Strength:
- Las opciones legales incluyen a John Smith AND a los personajes del oponente
- "Do your worst" requiere que el oponente elija John Smith "if able" (si es posible)
- Como John Smith es una opción legal, el oponente está obligado a elegirlo
- Hypnotic Strength se aplica a John Smith: roba una carta y John Smith gana Challenger +2 este turno
...
Cuando una habilidad estática contiene una restricción con "if able" (si es posible), esa restricción aplica cuando existe AL MENOS UNA opción legal que cumpla el criterio. Si el jugador tiene múltiples opciones pero UNA DE ELLAS está restringida, el jugador debe elegir la opción restringida si es legal.

**Definición crítica: Scope de "Chosen character" en acciones**

Una acción que dice simplemente "Chosen character" o "a character" SIN especificar propiedad (sin decir "your character", "one of your characters", "your opponent's character", etc.) permite elegir **CUALQUIER personaje en juego**, a menos que el contexto o una capacidad previa lo restrinja.

**Nota comparativa: "Si es posible" no evalúa el estado de la carta**
...
- [[John Smith - Obligado elegir si objetivo válido|Duda básica: ¿Estoy obligado a elegirlo si es válido?]]
- [[John Smith - Choose up to X no evita restricción|¿"Choose up to X" permite esquivar la restricción?]]
