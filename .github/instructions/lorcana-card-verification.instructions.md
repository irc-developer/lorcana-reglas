...
description: "Usar cuando un ruling, caso o explicación dependa del texto exacto de una carta concreta. Obliga a verificar nombre y texto exacto solo en 02. Listado de Cartas/Cartas de Lorcana.md antes de razonar."
---

# Verificación exacta de cartas

- No cierres un ruling sobre una carta específica sin verificar antes su texto exacto en `02. Listado de Cartas/Cartas de Lorcana.md`.
